...
############################################################################################
    ...
    print("\nMLE Confusion Matrix (Training):", confusionMatrix(listActualPredicted))
...
###########################################################################################
    ...
    print("\nBE Confusion Matrix (Training):", confusionMatrix(listActualPredictedBE))
...
# MLE Classification (Testing data)
    ...
    print("\nMLE Confusion Matrix (Testing Data):", confusionMatrix(listActualPredictedTestMLE))
...
# BE Classification (Testing data)
    ...
    print("\nBE Confusion Matrix (Testing Data):", confusionMatrix(listActualPredictedTestBE))
